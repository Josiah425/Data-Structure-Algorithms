...
int main() {
...

  {
    ...
    p = s + (cs240 + Word("rocks")) + s;
    std::cout << s + (cs240 + Word("rocks")) + s << std::endl;
    std::cout << p << std::endl;
    Story story("input.txt");
    story = p + story;
    std::cout << story << std::endl;
...

  {
    ...
    intro++;
    outro = outro + 1;
    std::cout << intro + story << std::endl;
    std::cout << '\n';
    std::cout << story + outro << std::endl;
    std::cout << '\n';
    std::cout << intro + story + outro << std::endl;
    story = intro + story + outro;
    story.save("output.txt");
    Paragraph p("Hello world. How are you today?");
    std::cout << "Paragraph: " <<  p << std::endl;
  }
